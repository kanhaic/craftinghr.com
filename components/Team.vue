<template>
  <div class="bg-white">
    <div class="mx-auto max-w-7xl px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
      ...
      <div class="grid grid-cols-1 gap-12 lg:grid-cols-2">
        <div v-for="member in teamMembers" :key="member.name" class="flex flex-col sm:flex-row sm:items-center">
          ...
          <div class="mt-8 sm:mt-0 sm:ml-10">
            ...
            <div class="mt-8">
              <a :href="member.linkedIn" target="_blank" rel="noopener noreferrer" class="inline-flex items-center text-sm font-semibold text-blue-600 transition-all duration-200 group hover:text-blue-800 hover:underline">
                Follow on LinkedIn
